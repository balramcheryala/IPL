...
public class IplHomeController {
	...
	public String helloFacebook(Model model) {
		FacebookConnectionFactory connectionFactory = new FacebookConnectionFactory("248167875567179",
	...
	@ResponseBody
	public ModelAndView searchbyname(@RequestParam(value = "by", required = true) String by,
