...
<center>
	...
	<form:form method="post" action="registrationform.html"
		...
		<table>
			...
			<tr>
				<td>Password:<FONT color="#AD1874"
					style="text-transform: lowercase"><form:errors
			...
			<tr>
				<td>Confirm Password:<FONT color="#AD1874"
					style="text-transform: lowercase;"><form:errors
			...
			<tr>
				<td>Email:<FONT color="#AD1874"
					style="text-transform: lowercase"><form:errors path="email"
							style="text-transform: uppercase" /></FONT></td>
			</tr>
			<tr>
