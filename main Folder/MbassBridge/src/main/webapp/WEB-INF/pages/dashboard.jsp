...
<body>
	<div class="main-wrapper">
		<div class="app" id="app">
			...
			<article class="content dashboard-page"> <section
				class="section">
						...
						<div class="card-header card-header-sm bordered">
							...
							<ul class="nav nav-tabs pull-right" role="tablist">
								...
								<li class="nav-item"><a class="nav-link" href="#downloads"
									role="tab" data-toggle="tab">Downloads</a></li>
							</ul>
						</div>
						<div class="card-block">
							...
							<li class="item">
								<div class="item-row">
									...
									<div class="item-col item-col-title no-overflow">
										<div>
											<a href="" class="">
												<h4 class="item-title no-wrap">12 Myths Uncovered About
													IT &amp; Software</h4>
											</a>
										</div>
									</div>
			...
			</section> <section class="section map-tasks">
			<div class="row sameheight-container">
				<div class="col-md-8">
		...
		<div class="item-col fixed item-col-actions-dropdown">
			<div class="item-actions-dropdown">
				<a class="item-actions-toggle-btn"> <span class="inactive">
						<i class="fa fa-cog"></i>
				</span> <span class="active"> <i class="fa fa-chevron-circle-right"></i>
				</span>
				</a>
				<div class="item-actions-block">
					<ul class="item-actions-list">
						...
						<li><a class="check" href="#"> <i class="fa fa-check"></i>
						</a></li>
