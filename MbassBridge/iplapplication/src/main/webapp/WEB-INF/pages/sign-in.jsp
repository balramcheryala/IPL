								...
								<div class="item-col fixed item-col-img md">
									<a href="signinby">
										<div class="item-img rounded"
											style="background-image: url(https :// upload.wikimedia.org/ wikipedia/ commons/ thumb/ 5/ 53/ Google_ % 22G % 22_Logo .svg/ 1024px-Google_ % 22G % 22_Logo .svg .png"></div>
									</a>
								</div>
						...
						<li class="item">
							<div class="item-row">
								...
								<div class="item-col fixed item-col-img md">
									<a href="signinby">
										<div class="item-img rounded"
											style="background-image: url(http :// www.blazingcatfur.ca/ wp-content/ uploads/ 2016/ 02/ Twitter-logo21.png"></div>
									</a>
								</div>
								<div class="item-col fixed pull-left item-col-title">
									<div class="item-heading">Name</div>
						...
						<li class="item">
							<div class="item-row">
								...
								<div class="item-col fixed item-col-img md">
									<a href="signinby">
										<div class="item-img rounded"
											style="background-image: url(https :// www.facebookbrand.com/ img/ fb-art.jpg"></div>
									</a>
								</div>
								<div class="item-col fixed pull-left item-col-title">
									<div class="item-heading">Name</div>
						...
						<li class="item">
							<div class="item-row">
								...
								<div class="item-col fixed item-col-img md">
									<a href="signinby">
										<div class="item-img rounded"
											style="background-image: url(https :// upload.wikimedia.org/ wikipedia/ commons/ thumb/ c/ ca/ LinkedIn_logo_initials.png/ 768px-LinkedIn_logo_initials .png"></div>
									</a>
								</div>
								<div class="item-col fixed pull-left item-col-title">
									<div class="item-heading">Name</div>
